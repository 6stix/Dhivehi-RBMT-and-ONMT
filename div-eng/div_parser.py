"""
This script tokenizes a Dhivehi corpus consisting of Biblical text. It separates punctuation!
...
books = ["GENESIS", "EXODUS", "RUTH", "SAMOne", "SAMTwo", "PRO", "JONAH", "MARK", "LUKE", "JOHN", "ދްއާމަނަވެ"] # PRO = proverbs

data = ""
with open('div-text.txt', 'r') as f:
  data = f.read()
...
### Space between Dhivehi-style quotes (“)
data = data.replace('“', ' “ ')
data = data.replace('  “', ' “')
data = data.replace('“  ', '“ ')
...
with open("parsed_div-text.txt", 'w') as f:
  f.write("\n".join(cp_data))
